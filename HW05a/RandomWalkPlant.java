...
class ImageFrame extends JFrame {
  ...
  public ImageFrame ( int width, int height ) {
    ...
    this.setTitle( "CAP 3027 2017 - HW05a - Logan Peck" );
  ...
  private void addMenu() {
    ...
    configColors.addActionListener( new ActionListener() {
      public void actionPerformed( ActionEvent event ) {
        ...
        int customStartColor = customColor1();
        int customEndColor = customColor2();
    ...
    private void plantRandom(int startColor, int endColor) {
      ...
      float startStrokeValue = 6.0f;
      float endStrokeValue = 0.5f;
